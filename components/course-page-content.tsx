  ...
  return (
    <>
          ...
          <div className="lg:col-span-2">
            ...
            {city && (
              <p className="text-ink-700 leading-relaxed">
                ...
                Ulearnsystems delivers weekend and weekday batches in {city.name} — both classroom (subject to venue availability) and live online — led by accredited
      ...
      <section className="section bg-ink-50/40">
        <div className="container-tight">
          <div className="text-center mb-10">
            <div className="badge mb-3">Why Ulearnsystems</div>
            <h2 className="h2">Why Choose Ulearnsystems for {course.shortTitle}</h2>
          </div>
