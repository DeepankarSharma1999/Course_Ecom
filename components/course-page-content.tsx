          ...
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            ...
            <div className="w-full lg:w-[480px] shrink-0">
              <div className="rounded-2xl overflow-hidden shadow-2xl relative bg-gray-100 aspect-[4/3] flex items-center justify-center border border-gray-200">
                <div className="absolute inset-0 bg-[#082032]/5"></div>
                <Lucide.Image className="w-16 h-16 text-gray-300" />
                <div className="absolute top-4 right-4 bg-white rounded-lg px-2 py-1 shadow text-[10px] font-bold flex items-center gap-1">
