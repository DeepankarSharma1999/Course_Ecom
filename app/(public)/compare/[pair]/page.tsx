...
export async function generateMetadata({ params }: { params: Promise<{ pair: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description: `Compare ${a.shortTitle} and ${b.shortTitle} side-by-side. Duration, price, exam, prerequisites and outcomes from MindClick.`,
      ...
      <section className="section bg-ink-50/40">
        <div className="container-tight grid lg:grid-cols-[1fr_400px] gap-10 items-start">
          <div>
            ...
            <p className="text-ink-700 mb-4">Speak with a MindClick training advisor — we&apos;ll review your career goals, current experience and team context to recommend the right certification path.</p>
