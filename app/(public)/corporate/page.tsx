        ...
        <div className="container-tight relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <a href="#inquire" className="btn bg-white text-primary hover:bg-white/90 rounded-full px-8 py-3 text-lg font-bold inline-flex items-center transition-colors shadow-lg">
                Request a Proposal
                <ChevronRight className="w-5 h-5 ml-2" />
              </a>
              <Link href="/courses" className="btn bg-white/10 hover:bg-white/20 text-white border border-white/20 rounded-full px-8 py-3 text-lg font-medium inline-flex items-center transition-colors">
                Explore Courses
              </Link>
            </div>
          </div>
