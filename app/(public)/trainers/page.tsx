    ...
    <>
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white">
        <div className="container-tight py-14">
          ...
          <p className="text-brand-100 text-lg max-w-2xl">Every MindClick trainer is an accredited practitioner with decades of real-world experience. They don&apos;t just teach the material — they live it every day.</p>
        </div>
      </section>
